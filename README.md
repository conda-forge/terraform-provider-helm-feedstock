About terraform-provider-helm-feedstock
=======================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-helm-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-helm-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-helm
# for installing globally
pixi global install terraform-provider-helm
```
...
It is possible to list all of the versions of `terraform-provider-helm` available on your platform:
...
```
pixi search terraform-provider-helm --channel conda-forge
```
